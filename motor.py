...
DIR = 16 # Pin 24 para dirección
STEP = 8  # Pin 26 para paso	
...
def step_motor():
    ...
    sleep(1)  # Puedes ajustar este tiempo según sea necesario
...
try:
    ...
    while True:
        GPIO.output(STEP, GPIO.HIGH)
        print("arriba")
        sleep(delay)  # Puedes ajustar este tiempo según sea necesario        GPIO.output(STEP, False)
        GPIO.output(STEP, GPIO.LOW)
        print("abajo")
        sleep(delay)# Puedes ajustar este	 tiempo según sea necesario)
